      ...
      <section class="steps">
        ...
        <IntersectionObserver :step="3" :noStyling="true">
          <section class="step" :class="{ isActive: text === 'well-defined' }">
            ...
            <p>An example of this process can be found for the pathways developed for the Overrijsselse Vecht in the Netherlands. [LINK to Dutch page]</p>
          </section>
        </IntersectionObserver>
        <IntersectionObserver :step="4" :noStyling="true">
          <section class="step" :class="{ isActive: text === 'ill-defined' }">
            ...
            <p>An example of this process can be found for adaptation options to address transnational climate risks developed for Kenya [LINK to Kenya page]</p>
          </section>
        </IntersectionObserver>
      </section>
    </div>
