<template>
  <figure class="graphic" :style="styling" :class="{ isLoaded }">
    <svg viewBox="0 0 1260 1260" ref="vis" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <marker v-for="orient in ['90', '180', '270']" :id="`arrow-${orient}`" markerWidth="16" markerHeight="16" refX="8" refY="8" markerUnits="1px" :orient="orient">
      ...
      <g :class="isHighlight('left')">
        ...
        <BoxGroup :x="200" :y="434" color="green" :head="['Brainstorming']" :text="['Nested scenarios']" link="https://climatescenarios.org/finder/?name=BRAINSTORMING" />
        <BoxGroup :x="200" :y="582" color="blue" :head="['Morphological analysis/', 'intuitive logic']" :text="['Narratives and cartoons']" link="https://climatescenarios.org/finder/?name=MORPHOLOGICAL%20ANALYSIS" />
        <BoxGroup :x="200" :y="731" color="blue" :head="['SWOT analysis']" :text="['Risk Assessment']" link="https://climatescenarios.org/finder/?name=SWOT%20ANALYSIS" />
      </g>

      <g :class="isHighlight('right')">
        <path class="path" d="M780,290 L1060,290 L1060,950 L800,950" marker-end="url(#arrow-90)" />

        <BoxGroup :x="1060" :y="434" color="green" :head="['Visioning']" :text="['Vision']" link="https://climatescenarios.org/finder/?name=VISIONING" />
        <BoxGroup :x="1060" :y="582" color="green" :head="['Backcasting']" :text="['Pathways']" link="https://climatescenarios.org/finder/?name=BACKCASTING" />
        <BoxGroup :x="1060" :y="731" color="green" :head="['Participatory systems', 'dynamics']" :text="['Transformative pathways ']" link="https://climatescenarios.org/finder/?name=PARTICIPATORY%20SYSTEMS" />
      </g>

      <g :class="{ isHighlight: highlights.length === 0 }">
        <Box :x="630" :y="949" w="whide" h="tall" color="green" :text="['Adaptation', 'scenarios']" font="big" />
        <Box :x="630" :y="873" w="default" h="default" color="white" :text="['Robust Decision Making', '(trade-offs and robustness)']" link="https://climatescenarios.org/finder/?name=ROBUST%20DECISIONMAKING" />
...
export default {
  ...
  mounted () {
    ...
    isHighlight (t) {
      return { isHighlight: this.highlights.includes(t) || this.highlights.length === 0 }
    }
  }
}
</script>
